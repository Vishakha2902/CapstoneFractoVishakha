...
//         [HttpGet]
//         public async Task<IActionResult> GetAll([FromQuery] string? city, [FromQuery] int? specializationId, [FromQuery] double? minRating)
//         {
...
//             var booked = await _db.Appointments.Where(a => a.DoctorId == id && a.AppointmentDate.Date == date.Date && a.Status == "Booked")
